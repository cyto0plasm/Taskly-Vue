...
@section('main')
    ...
    <style>
        ...
        <section
            ...
            <div class="absolute bottom-20 right-10 w-40 h-40 bg-emerald-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"
            ...
            <div class="w-full lg:w-1/2 flex flex-col justify-center gap-8 text-center lg:text-left">
                ...
                <p class="text-gray-600 dark:text-gray-300 text-lg lg:text-xl max-w-md mx-auto lg:mx-0 ">
                    The all-in-one workspace where teams
                    plan, track, and deliver projects with
                    clarity and confidence. </p>
                <div class="flex flex-col items-center lg:items-start">
                    <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 text-nowrap">
                        <a href="{{ route('login') }}"
                            class="  inline-flex items-center justify-center px-14 py-3 text-lg bg-[#7433ed] font-semibold hover:bg-[#7B4DD3] hover:scale-[1.02] transition-all duration-200 text-white rounded-xl shadow-lg">
                            Continue where you left
                        </a>

                        <a href="#See_How_It_Works"
                            class="inline-flex items-center justify-center gap-2 px-4 py-3 text-lg text-emerald-600 dark:text-emerald-400 font-semibold border-2 border-emerald-600 dark:border-emerald-500 rounded-xl hover:bg-emerald-600 dark:hover:bg-emerald-500  hover:text-white dark:hover:text-black transition-all duration-300">
                            See How It Works
                    ...
                    <div class="flex flex-row gap-3 text-nowrap ">
                        <div class="flex flex-row items-center">
                            ...
                            <p class="px-2 py-2 text-gray-700 dark:text-gray-500 font-semibold "> No
                                credit card
                                required
                            </p>
                        ...
                        <div class="flex flex-row items-center">
                            <x-svg.check-mark-circle></x-svg.check-mark-circle>
                            <p class="px-2 py-2 text-gray-700 dark:text-gray-500 font-semibold ">
                                Free forever plan
                            </p>
            ...
            <div class="w-full lg:w-1/2 flex items-center justify-center">
                <img src="{{ asset('images/Work anniversary-bro.png') }}" alt="Hero Image"
                    class="w-full max-w-xl lg:max-w-2xl object-contain drop-shadow-md" />
            </div>
        </section>
