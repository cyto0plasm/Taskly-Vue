...
use App\Http\Controllers\Api\UserControllerApiVue;
...
Route::middleware('auth:sanctum')->group(function () {
    Route::get('/user', [UserControllerApiVue   ::class, 'show']);
    Route::patch('/user', [UserControllerApiVue::class, 'update']);
    Route::patch('/user/preferences', [UserControllerApiVue::class, 'updatePreferences'])
...
Route::prefix('dashboard')->group(function(){
    Route::get('/auth/stats', [DashboardControllerApiVue::class, 'authView']);
    Route::get('/auth/widgets', [DashboardControllerApiVue::class, 'widgetsView']);
